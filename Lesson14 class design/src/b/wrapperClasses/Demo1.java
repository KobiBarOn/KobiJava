...
public class Demo1 {
	...
	public static void main(String[] args) {
		...
		{// inboxing and outboxing
			...
			int aPrimitive = x.intValue(); // outboxing - Wrapper to primitive

			Integer y = 5; // auto-inbox = prefferd method
			int bOtherPrimitive = y; // auto outboxing
			System.out.println(bOtherPrimitive); // b is primitive - no methods, just value
			System.out.println(y.doubleValue()); // y is an object - has methods
		}
		{ // minimum and maximum
			...
			if (x >= Byte.MIN_VALUE && x <= Byte.MAX_VALUE) {
				...
				System.out.println("casting of: " + x + " to byte will overflow");
			}
